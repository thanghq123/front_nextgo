...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.ReportService.general().subscribe((data: any) => {
      this.totalToday = data.payload.total;
      this.totalBillToday = data.payload.order_completed;
    });

    this.ReportService.income('today').subscribe((data: any) => {
      this.dataChartRevenue = data.payload;
    });
  ...
  getInfoClick(status: number) {
    ...
    this.ReportService.income(optionDate).subscribe((data: any) => {
      this.dataChartRevenue = data.payload;
    });
